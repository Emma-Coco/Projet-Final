    ...
    if ($startDate[0] >= $dateNow->getTimestamp()) {
        if ($endDate < $startDate) {
            ...
            if($isDatesAvailable){
                ...
                echo '<input type="submit" name="cancel_booking" style="background-color: #FF8675; position: absolute; top: 1250px; left: 350px; padding: 10px; border-radius: 10px; z-index: 30;" value="Annuler">';
        ...
        $reponseBooking = '<div style="position: absolute; top: 60px; color: #FF8675; font-size: 20px;">' . "Vous ne pouvez pas définir une date dans le passé !" . '</div>';
    }
}
