...
<h2>Description du logement</h2>
    ...
    <form action="../controlleurs/CreateAnnouncement.php" method="POST">
        ...
        <textarea id="description" name="description" rows="4" cols="50" required placeholder="Décrivez l'hébergement"></textarea><br><br>
        ...
        <input type="number" id="voyageurs" name="voyageurs" required placeholder="Entrez le nombre de voyageurs"><br><br>
        ...
        <input type="number" id="chambres" name="chambres" required placeholder="Entrez le nombre de chambres"><br><br>

        <label for="cuisine">Cuisine :</label>
        <input type="text" id="cuisine" name="cuisine" required placeholder="Indiquez s'il y a une cuisine"><br><br>

        <label for="sallesDeBain">Nombre de salles de bain :</label>
        <input type="number" id="sallesDeBain" name="sallesDeBain" required placeholder="Entrez le nombre de salles de bain"><br><br>
