...
>>>>>>> Stashed changes
    <div class="info">
      <p>Plus de 300 hébergements Jan · 16 jan. - 27 jan.</p>
      <a class="link-info" href="https://www.airbnb.com.br/resources/hosting-homes?persona=guest">
        Consultez les dernières informations sur notre réponse au COVID-19
      </a>
      <br />

      <h1>Logement a Paris</h1>

      <div class="info__orders">
        <button class="info__orders--button" onclick="orderByNameAZ()">
          A-Z
        </button>

        <button class="info__orders--button" onclick="orderByNameZA()">
          Z-A
        </button>
        ...
        <button class="info__orders--button" onclick="orderByPriceDecreasing()">
          Valeur la plus élevée
        </button>

        <input id="searchInput" class="info__orders--button" onkeyup="handleSearch()"
          placeholder="Rechercher votre propriété" />
      </div>
    </div>
