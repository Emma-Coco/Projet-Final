      ...
      <form action="../controlleurs/pub_controlleur.php" method="post">
        ...
        <div class="header__info">
          ...
          <input style="display:none"type="Date">
            <input type="text" name="Départ" class="header__info--input" placeholder="Date de départ" onfocus="(this.type='Date')" onblur="if(!this.value) this.type='text'" />
          </div>
          <div style="border-right: 1px solid black">
          <input style="display:none"type="Date">
            <input type="text" name="Arrivée" class="header__info--input" placeholder="Date d'arrivée" onfocus="(this.type='Date')" onblur="if(!this.value) this.type='text'" />
          </div>
          <div>
